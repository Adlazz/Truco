...
# Comparar cartas y determinar ganador de la primera jugada
ganador_primera_jugada = mazo.comparar_cartas(carta_jugada_jugador1, carta_jugada_computadora)

# Determinar siguiente jugador para la segunda jugada
if ganador_primera_jugada:
    proximo_jugador = ganador_primera_jugada
else:
    proximo_jugador = primer_jugador

print(f"\nSiguiente jugada, turno de {proximo_jugador}:")

# Mostrar las cartas de jugador 1 y la computadora SEGUNDA RONDA
print("\nCartas del jugador 1:")
for carta in jugador1_cartas:
    print(carta)
print("\nCartas de la computadora:")
...
# Comparar cartas y determinar ganador de la primera jugada
ganador_segunda_jugada = mazo.comparar_cartas(carta_jugada_jugador1, carta_jugada_computadora)

# Determinar siguiente jugador para la segunda jugada
if ganador_segunda_jugada:
    proximo_jugador = ganador_segunda_jugada
else:
    proximo_jugador = primer_jugador
